#!/bin/bash
set -euo pipefail
cd /Users/andersonedmond/SyntheticResponderLab-focus-group
...
for round in 1 2 3; do
  ...
  $CODEX exec --cd /Users/andersonedmond/SyntheticResponderLab-focus-group --sandbox workspace-write --skip-git-repo-check -m gpt-6-astra \
    "$brief
